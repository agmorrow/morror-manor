<template>
  <footer class="text-center lg:text-left bg-gray-200 text-gray-600">
    ...
    <div class="mx-6 pt-4 text-center md:flex justify-around">
      <p class="flex items-center justify-center md:justify-start">
          <a href="https://www.instagram.com/morrowmanorphoto/" class="mr-4 text-gray-600">
